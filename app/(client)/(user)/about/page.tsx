...
const AboutPage = () => {
  return (
    <Container className="max-w-6xl lg:px-8 py-12">
      <h1 className="text-3xl font-bold mb-6">About Fabrix</h1>
      <p className="mb-4">
        Fabrix is a cutting-edge technology company dedicated to providing
      ...
      <p>
        At Fabrix, we believe in the power of technology to transform businesses
